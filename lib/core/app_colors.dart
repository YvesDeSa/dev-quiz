...
class AppColors {
  ...
  static final Color levelButtonBorderDifficult = Color(0xFFE5D5C5);
  ...
  static final Color levelButtonTextDifficult = Color(0xFFE8891C);
